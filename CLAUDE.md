...
**YOU ARE IN: `footy_track/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/footy_track/` (rig root) or other directories
...
**Your mail address:** `footy_track/polecats/obsidian`
**Your rig:** footy_track
**Your Witness:** `footy_track/witness`
...
| Ask Witness for help | `gt mail send footy_track/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`footy_track/witness`) when:
...
```bash
gt mail send footy_track/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
