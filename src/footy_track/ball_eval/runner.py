...
def _score_clip(tracker: BallTracker, clip, verbose: bool = False) -> ClipMetrics:
    ...
    frame_size: tuple[int, int] = (1080, 1920)  # updated from first frame
    ...
    for frame_idx, frame_rgb in clip.iter_frames():
        ...
        # Populate center from explicit center field or derived from bbox
        gt_center_norm = gt_label.ball_center() if gt_label is not None else None
